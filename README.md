...
Builds the app for characterion to the `build` folder.<br />
It correctly bundles React in characterion mode and optimizes the build for the best performance.
